...
public class EmulShadowWatch extends GhidraScript {
  EmulatorHelper emu;
  ...
  public void run() throws Exception {
    ...
    Set<Long> seenWriter=new HashSet<>();
    println(String.format("SHADOW-WATCH from %x budget=%d bridge@%d",entry,budget,bridgeStep));
    try{
